...
public class CreateCourseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!name.isEmpty()) {
            ...
            if (!alreadyExist) {
                resp.sendRedirect("/addcourses?message=<p><mark>" + name + " already exists in the database! Please try again.</mark></p>");
            } else {
                resp.sendRedirect("/addcourses?message=<p>Successfully added " + name + " to the database!</p>");
            }
        } else {
